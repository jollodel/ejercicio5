...
export class OffersListComponent implements OnChanges {
  ...
  offersOther: Offer[] = [];
  dataSource;
  displayedColumns: string[] = ['job', 'company', 'category', 'date', 'province', 'municipe', 'subscribe', 'editar'];
  displayedColumnsOther: string[] = ['job', 'company', 'category', 'date', 'province', 'municipe'];
  constructor() {}
