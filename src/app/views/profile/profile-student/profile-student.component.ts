...
export class ProfileStudentComponent {
  ...
  displayedColumns: string[] = ['level', 'grade', 'title', 'institution', 'date', 'certificate', 'bilingue', 'dual', 'editar', 'eliminar'];
  displayedColumnsLang: string[] = ['level', 'name', 'date', 'editar', 'eliminar'];
  dataSource;
  ...
  ngOnInit(){
    this.dataSource=this.user.studies;
  }
